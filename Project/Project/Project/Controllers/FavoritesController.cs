...
namespace Project.Controllers
{
    public class FavoritesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("userid,stationid")] Favorite favorite)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("userid,stationid")] Favorite favorite)
        {
